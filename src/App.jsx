    ...
    >
      <MantineProvider theme={{ colorScheme }}>
        <Routes>
          ...
          <Route path="/department/add-teamleader" element={<EditTeamLeader />} />
        ...
        <Route path="/management/all-services" element={<AllServices />} />
          ...
          {/* Facilities  */}
          <Route path="/management/all-facilities" element={<AllFacilities />} />
          <Route path="/management/add-facilities" element={<AddFacilities />} />
          <Route path="/management/edit-facilities" element={<EditFacilities />} />
          {/* Restaurant Menu  */}
